 ...
 *
 * This setup supports two approaches for handling languages:
 *
 * 1. URL-based routing (Next.js default)
 *    - The language is included in the URL path
 *    - Example: /en/about, /fr/about
 *    - @see https://nextjs.org/docs/pages/building-your-application/routing/internationalization
 *    - Or using i18next:
 *    - @see https://github.com/i18next/next-i18next?tab=readme-ov-file#app-router-setup
 *
 * 2. Cookie-based routing
 *    - The selected language is stored in cookies
 *    - No changes to the URL are required
 *    - @see https://github.com/i18next/next-app-dir-i18next-example/issues/12#issuecomment-1500917570
 *
 * The current implementation uses approach #2 (cookie-based routing).
 */
